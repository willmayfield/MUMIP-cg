...
#    cdo -f nc4 copy ${input_dir}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z.grb    ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z.nc
    ...
    #for ((j=${lev_start};j<=${lev_end};j++)); do
            ...
            ##rm ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z_${j}.nc       # needed for theta_l calculation
...
for ((i=${day_start};i<=${day_end};i++)) ; do
    ...
    #for ((j=${lev_start};j<=${lev_end};j++)); do
            ...
            # extract vertical level
            #ncks -d height,${j} ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z.nc    ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z_${j}.nc
	    #ncks -d height,${j} ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_ml_${i}T000000Z.nc    ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_ml_${i}T000000Z_${j}.nc
	    #ncks -d height,${j} ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_rl_ml_${i}T000000Z.nc    ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_rl_ml_${i}T000000Z_${j}.nc

            # merge
            cdo merge ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_ml_${i}T000000Z_${j}.nc ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z_${j}.nc ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_rl_ml_${i}T000000Z_${j}.nc ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_t_rl_ml_${i}T000000Z_${j}.nc

            # compute theta_l at full resolution
	    cdo -expr,'thetal=theta-(theta/ta)*((2.501*10^6)/1005.7)*rl' ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_t_rl_ml_${i}T000000Z_${j}.nc ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_thetal_ml_${i}T000000Z_${j}.nc

            # regrid
            cdo -P 4 -O remap,${resol_target}_grid.nc,ICON_${resol_target}_grid_wghts.nc ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_thetal_ml_${i}T000000Z_${j}.nc ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${j}_tmp.nc

            # convert height to record dimension
            ncpdq -a height,time ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${j}_tmp.nc ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${j}.nc

            # extract desired region
            cdo -sellonlatbox,${minlon},${maxlon},${minlat},${maxlat} ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${j}.nc ${output_dir}/${region}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${region}_${j}.nc

            # tidy a little
            rm ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${j}_tmp.nc
            rm ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_t_ml_${i}T000000Z_${j}.nc
            rm ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_ml_${i}T000000Z_${j}.nc
            rm ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_theta_t_rl_ml_${i}T000000Z_${j}.nc
	    rm ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_rl_ml_${i}T000000Z_${j}.nc
            rm ${output_dir_nat}/nwp_R2B10_lkm1007_atm_3d_thetal_ml_${i}T000000Z_${j}.nc

    done

    # merge all levels
    ncrcat ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_*.nc ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_tmp.nc
    ncrcat ${output_dir}/${region}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${region}_*.nc ${output_dir}/${region}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${region}_tmp.nc

    # restore time as record dimension
    ncpdq -a time,height ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_tmp.nc ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z.nc
    ncpdq -a time,height ${output_dir}/${region}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${region}_tmp.nc ${output_dir}/${region}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${region}.nc

    # tidy: delete individual level files and tmp files
    rm ${output_dir}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_*.nc
    rm ${output_dir}/${region}/nwp_R2B10_lkm1007_${resol_target}_atm_3d_thetal_ml_${i}T000000Z_${region}_*.nc
